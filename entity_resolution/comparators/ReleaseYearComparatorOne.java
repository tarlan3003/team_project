 ...
 * value with a tolerance of 1 years.
 */
public class ReleaseYearComparatorOne implements Comparator<SteamGame, Attribute> {

    private static final long serialVersionUID = 1L;
    private int tolerance = 1;  // Tolerance of 5 years
